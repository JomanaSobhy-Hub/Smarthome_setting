    ...
    return Scaffold(
     ...
     body: SingleChildScrollView(
      child: Column(
        ...
        children: [
          AppGreenCont(height: 160, text1: 'Get started', text2: 'Creat account'),
           SizedBox(height: 10),
           Column(
              children: [
                Padding(padding: EdgeInsets.all(20)),

                app_text_field(hintText: 'Jomana Sobhy', text: 'Full name'),
                SizedBox(height: 20),
                app_text_field(hintText: 'sobhyjomana@2gmail.com', text: 'Email address'),
                SizedBox(height: 20),
                app_text_field(hintText: 'Create a password', text: 'Password'),
                SizedBox(height: 20),
                app_text_field(hintText: 'Repeat your password', text: 'Confirm password'),
                SizedBox(height: 6),
                 rowcheck(),
                    SizedBox(height: 10),
...
Widget rowcheck(){
  ...
  activeColor: const Color(0xFF2D4A3E), // اللون لما يتعمل عليه صح (نفس أخضر الهيدر عندك)
                ...
                TextSpan(
                  ...
                  children: <TextSpan>[
                    TextSpan(
                      ...
                      style: TextStyle(color: Color(0xFF2D4A3E),fontWeight: FontWeight.bold),
                    ),
                    TextSpan(
                      text: ' and ',
