...
class _SHeditedState extends State<SHedited> {
  // متغير لتحديد الأيقونة النشطة حالياً
  //int _currentIndex = 0;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
              ...
              SizedBox(
                ...
                child: ListView(
                  ...
                  children: [
                    ...
                    leading: ClipRRect(
                      borderRadius: BorderRadius.all(Radius.circular(16)),
                      child: Image.network('https://tse3.mm.bing.net/th/id/OIP.ho7QLJRBtJlqKjTfWhMblwHaE8?rs=1&pid=ImgDetMain&o=7&rm=3',width: 80,height:100 ,fit: BoxFit.cover,) ,
                    ...
                    leading: ClipRRect(
                      borderRadius: BorderRadius.all(Radius.circular(16)),
                      child: Image.network('https://tse1.mm.bing.net/th/id/OIP.lyb29fcPu3zVpgnh-YEuqQHaEL?w=800&h=451&rs=1&pid=ImgDetMain&o=7&rm=3',width: 80,height:100 ,fit: BoxFit.cover,) ,
                    ...
                    leading:ClipRRect(
                      borderRadius: BorderRadius.all(Radius.circular(16)),
                      child: Image.network('https://static.vecteezy.com/system/resources/previews/028/137/999/non_2x/kitchen-and-dining-area-in-a-large-house-photo.jpg',width: 80,height:100 ,fit: BoxFit.cover,) ,
                  ...
                  //   // leading: ClipRRect(
                  //   //   borderRadius: BorderRadius.all(Radius.circular(16)),
                  //   //   child: Image.asset('assets/images/living_room.png',width: 80,height:100 ,fit: BoxFit.cover,) ,
      ...
      // التعديل هنا لجعل الـ BottomNavigationBar يعمل بشكل صحيح
